  ...
  constructor(customMappings: WordStyleMappings = {}) {
    this.defaultMappings = {
      paragraphs: {
        ...
        'Heading 2': 'https://pub.xats.org/vocabularies/blocks/heading',
        'Heading 3': 'https://pub.xats.org/vocabularies/blocks/heading',
        'Heading 4': 'https://pub.xats.org/vocabularies/blocks/heading',
        'Heading 5': 'https://pub.xats.org/vocabularies/blocks/heading',
        'Heading 6': 'https://pub.xats.org/vocabularies/blocks/heading',
        Quote: 'https://pub.xats.org/vocabularies/blocks/blockquote',
        'Intense Quote': 'https://pub.xats.org/vocabularies/blocks/blockquote',
        Code: 'https://pub.xats.org/vocabularies/blocks/codeBlock',

        // Educational-specific styles
        'Learning Objective': 'https://pub.xats.org/vocabularies/blocks/learningObjective',
        'Key Term': 'https://pub.xats.org/vocabularies/blocks/keyTerm',
        ...
        Exercise: 'https://pub.xats.org/vocabularies/blocks/exercise',
        Note: 'https://pub.xats.org/vocabularies/blocks/note',
        Warning: 'https://pub.xats.org/vocabularies/blocks/warning',
        Tip: 'https://pub.xats.org/vocabularies/blocks/tip',
        Summary: 'https://pub.xats.org/vocabularies/blocks/summary',
      },
      characters: {
      ...
      tables: {
        'Table Grid': 'https://pub.xats.org/vocabularies/blocks/table',
        'Table Professional': 'https://pub.xats.org/vocabularies/blocks/table',
        'Data Table': 'https://pub.xats.org/vocabularies/blocks/table',
      },
      lists: {
        'List Paragraph': 'https://pub.xats.org/vocabularies/blocks/list',
        Bullet: 'https://pub.xats.org/vocabularies/blocks/list',
        Number: 'https://pub.xats.org/vocabularies/blocks/list',
      },
    };
