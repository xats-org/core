              ...
              sections: [
                {
                  ...
                  content: [
                    {
                      id: 'block-1',
                      blockType: 'https://pub.xats.org/vocabularies/blocks/paragraph', // Valid URI
                      content: {
                        text: {
                          runs: [{ type: 'text', text: 'Test content' }],
                        },
          ...
          contents: [
            {
              ...
              renderingHints: [
                {
                  hintType: 'https://pub.xats.org/vocabularies/hints/breakBefore', // Valid URI
                  value: true,
                },
              ],
              sections: [
    ...
    it('should enforce URI format for resource URL', () => {
      const doc = {
        ...
        resources: [
          {
            id: 'resource-1',
            type: 'https://pub.xats.org/vocabularies/resources/image',
    ...
    it('should accept valid URIs for resource fields', () => {
      const doc = {
        ...
        resources: [
          {
            id: 'resource-1',
            type: 'https://pub.xats.org/vocabularies/resources/image', // Valid URI
          ...
          contents: [
            {
              ...
              pathways: [
                {
                  trigger: {
                    triggerType: 'https://pub.xats.org/vocabularies/triggers/onAssessment', // Valid URI
                    sourceId: 'assessment-1',
                  },
                  rules: [
                    {
                      condition: 'score >= 70',
                      destinationId: 'next-section',
                      pathwayType: 'https://pub.xats.org/vocabularies/pathways/standard', // Valid URI
                    },
                  ],
                },
              ],
                  ...
                  content: [
                    {
                      id: 'block-1',
                      blockType:
                        'https://pub.xats.org/vocabularies/blocks/custom-block?param=value&other=123', // URI with query params
                      content: {
                        customField: 'value',
                      },
                    },
