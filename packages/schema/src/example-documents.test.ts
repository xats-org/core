            ...
            pathways: [
              {
                ...
                rules: [
                  ...
                  },
                  {
                    ...
                    pathwayType: 'https://pub.xats.org/vocabularies/pathways/remedial',
                  },
                  {
                    condition: 'score < 60',
                    destinationId: 'fundamentals-review',
                    pathwayType: 'https://pub.xats.org/vocabularies/pathways/prerequisite',
                  },
                ],
              },
            ],
  ...
  function createResourcesExample() {
    return {
      ...
      resources: [
        ...
        {
          id: 'video-1',
          type: 'https://pub.xats.org/vocabularies/resources/video',
        ...
        contents: [
          {
            ...
            pathways: [
              ...
              {
                trigger: {
                  triggerType: 'https://pub.xats.org/vocabularies/triggers/onCompletion',
                },
                rules: [
                  {
