...
describe('LaTeX Round-trip Tests', () => {
  ...
  describe('Basic Round-trip', () => {
    it('should preserve simple document structure', async () => {
              ...
              contents: [
                {
                  ...
                  content: {
                    runs: [
                      {
                        runType: 'text',
                        text: 'This is a test paragraph for round-trip conversion.',
                      },
                    ],
                  },
                },
      ...
      expect(roundTripResult.roundTrip.bibliographicEntry.title).toBe(
        originalDocument.bibliographicEntry.title
      );
  ...
  describe('Performance and Metrics', () => {
              ...
              contents: Array.from({ length: 50 }, (_, i) => ({
                ...
                content: {
                  runs: [
                    {
                      runType: 'text',
                      text: `This is paragraph ${i + 1} for performance testing.`,
                    },
                  ],
                },
              })),
    ...
    it('should provide detailed difference analysis', async () => {
      ...
      const criticalDifferences = roundTripResult.differences.filter(
        (d) => d.impact === 'critical'
      );
