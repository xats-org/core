...
- **Extension ID**: `https://pub.xats.org/extensions/content-transformation/schema.json`
- **Version**: 1.0.0
      ...
      "transformationRules": [
        {
          ...
          "sourceFormat": "markdown",
          "targetBlockType": "https://pub.xats.org/vocabularies/blocks/heading",
          "pattern": "^(#{1,6})\\s+(.+)$",
          "transformation": {
            "extractText": {
              "method": "regex",
        ...
        },
        {
          ...
          "sourceFormat": "markdown",
          "targetBlockType": "https://pub.xats.org/vocabularies/blocks/paragraph",
          "pattern": "^(?!#|\\*|\\-|\\d+\\.)(.+)$",
          "transformation": {
            "preserveFormatting": {
              "emphasis": true,
      ...
      "transformationRules": [
        {
          "ruleId": "math-block",
          "sourceFormat": "markdown",
          "targetBlockType": "https://pub.xats.org/vocabularies/blocks/mathBlock",
          "pattern": "^\\$\\$([\\s\\S]*?)\\$\\$$",
          "transformation": {
            "extractText": {
              "method": "regex",
          ...
          "conditions": [
            {
              "property": "blockType",
              "operator": "equals",
              "value": "https://pub.xats.org/vocabularies/blocks/quiz"
            }
          ],
          "from": "https://pub.xats.org/vocabularies/blocks/quiz",
          "to": "https://pub.xats.org/vocabularies/blocks/multipleChoice"
        },
        {
...
This is a paragraph.
  ...
  test('should handle math blocks correctly', async () => {
    ...
    expect(mathBlock.blockType).toBe('https://pub.xats.org/vocabularies/blocks/mathBlock');
