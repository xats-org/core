...
**Canonical URL:** `https://pub.xats.org/specs/core-vocabularies`
...
- **URI:** `https://pub.xats.org/vocabularies/blocks/paragraph`
  - **Description:** A standard block for prose text. The `content` property must be a `SemanticText` object.

- **URI:** `https://pub.xats.org/vocabularies/blocks/list`
...
- **URI:** `https://pub.xats.org/vocabularies/blocks/image`
...
- **URI:** `https://pub.xats.org/vocabularies/blocks/table`
...
- **URI:** `https://pub.xats.org/vocabularies/blocks/definition`
...
- **URI:** `https://pub.xats.org/vocabularies/blocks/theorem`
...
- **URI:** `https://pub.xats.org/vocabularies/blocks/example`
  - **Description:** A callout for a specific example. The `content` property must be a `SemanticText` object.

- **URI:** `https://pub.xats.org/vocabularies/blocks/quote`
...
- **URI:** `https://pub.xats.org/vocabularies/placeholders/tableOfContents`
...
- **URI:** `https://pub.xats.org/vocabularies/placeholders/bibliography`
...
- **URI:** `https://pub.xats.org/vocabularies/placeholders/index`
...
- **Triggers (`triggerType`):**
  - `https://pub.xats.org/vocabularies/triggers/onCompletion`
  - `https://pub.xats.org/vocabularies/triggers/onAssessment`
- **Types (`pathwayType`):**
  - `https://pub.xats.org/vocabularies/pathways/remedial`
  - `https://pub.xats.org/vocabularies/pathways/enrichment`
  - `https://pub.xats.org/vocabularies/pathways/prerequisite`
  - `https://pub.xats.org/vocabularies/pathways/standard`

---

## 5. Resource Types

- **URI:** `https://pub.xats.org/vocabularies/resources/image`
- **URI:** `https://pub.xats.org/vocabularies/resources/video`
- **URI:** `https://pub.xats.org/vocabularies/resources/audio`
- **URI:** `https://pub.xats.org/vocabularies/resources/transcript`