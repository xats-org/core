...
- **New Pedagogical Content Types**: Enhanced learning experiences
  - **Case Study Blocks** (`https://pub.xats.org/vocabularies/blocks/caseStudy`):
  ...
  - **Metacognitive Prompt Blocks** (`https://pub.xats.org/vocabularies/blocks/metacognitivePrompt`):
