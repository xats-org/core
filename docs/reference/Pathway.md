...
| `trigger.triggerType` | `string` (URI) | **Yes** | The event type (e.g., `https://pub.xats.org/vocabularies/triggers/onCompletion`, `https://pub.xats.org/vocabularies/triggers/onAssessment`). |
