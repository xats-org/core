...
- `https://pub.xats.org/vocabularies/blocks/*` → `https://pub.xats.org/vocabularies/blocks/*`
- `https://pub.xats.org/vocabularies/placeholders/*` → `https://pub.xats.org/vocabularies/placeholders/*`
- `https://pub.xats.org/vocabularies/hints/*` → `https://pub.xats.org/vocabularies/hints/*`
